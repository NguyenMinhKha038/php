		...
		<div class="container-menu-header">
			<div class="topbar">
				...
				<span class="topbar-child1">
					Miễn phí giao hàng cho đơn hàng trên 100$
				</span>
				...
				<div class="topbar-child2">
					...
					<div class="topbar-language rs1-select2">
						<select class="selection-1" name="time" onchange="location = this.value;">
							<option>Language</option>
							<option value="locale/vi">VIE(Default)</option>
							<option value="locale/en">ENG</option>
			...
			<div class="wrap_header">
				...
				<a href="index.html" class="logo">
					<img src="frontend/images/icons/119222903_323810525603287_1607834021328058661_n.png" alt="IMG-LOGO">
				</a>
				...
				<div class="wrap_menu">
					<nav class="menu">
						<ul class="main_menu">
							...
							<li>
								<a href="#">@lang('home.store_menu')</a>
								<ul class="sub_menu">
									@foreach($type_product as $type)
									<li><a href="{{route('store',$type->id)}}">{{$type->name}}</a></li>
									@endforeach
								</ul>
							</li>

							<li>
								<a href="{{route('listcart')}}">@lang('home.cart_menu')</a>
							</li>

							<li>
								<a href="blog.html">@lang('home.blog_menu')</a>
							</li>

							<li>
								<a href="{{route('about')}}">@lang('home.about_menu')</a>
							</li>

							<li>
								<a href="{{route('contact')}}">@lang('home.contact_menu')</a>
							</li>
						</ul>
					</nav>
				</div>
				...
				<div class="header-icons">
						<ul class="main_menu">
							...
							<ul class="sub_menu">
								<li><a href="/">@lang('home.info_menu') {{Auth::user()->name}}</a></li>
							...
							@foreach($products as $pr)
								<li class="header-cart-item">
									<div class="header-cart-item-img">
										<img src="frontend/image/product/{{$pr->options->image}}" alt="IMG">
									</div>
